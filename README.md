...
- momentJS - [Parse, validate, manipulate, and display dates](http://momentjs.com/) in JavaScript. We used this to do backend and frontend calculations on time. It is one of the most useful libraries I have ever come across.
